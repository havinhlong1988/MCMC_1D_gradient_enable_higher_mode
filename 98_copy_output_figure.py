...
# =======================
PWD = os.getcwd()
STATION_FILE = os.path.join(PWD, "CHT", "station_cor.lst")
SEP = r"\s+"
HEADER = None
...
def main():
    ...
    # Read stations: new format name long lat dist
    if HEADER is None:
        df = pd.read_csv(
            station_path,
            sep=SEP,
    ...
    # Keep station name from first column and normalize 00000 style
