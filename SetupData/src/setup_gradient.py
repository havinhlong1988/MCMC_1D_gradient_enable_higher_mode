...
def setup(stadata,Vel_dir,src_dir,query_sub,data_sub):
    # print(stadata)
    # --------------------------------------------------------------------------------------------------------
...
# ---------------------- Now we find the sediment depth and moho depth ---------------------------
    ...
    # --------------------------------------------------------------------------------------------------------   
    fndara = os.path.join(data_sub, f"in.data_{stadata['name']}")
...
# # ----------------- >>>>> More calculation >>>> print to mod.{STA} ---------------------------------
    ...
    if (parameters.sed_flag==1):
        ...
        locals()['modsedlayer']=SedLayerId+' '+parameters.modlinear+' %4.1f'%(sthick)+' %d'%(parameters.sednpara)+\
    ...
    # 
    locals()['modcrustlayer']=CrustLayerId+' '+parameters.modsplines+' %4.1f %d'%(crustthick,parameters.crustnpara)+printcrusttmp+\
    ...
    if (parameters.man_flag==1):
        ...
        locals()['modmantlelayer']=ManLayerId+' '+parameters.modsplines+' %4.1f %d '%(mantlethick,parameters.mantlenpara)+printmantletmp+\
